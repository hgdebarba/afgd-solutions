...
{
    public class JacobianTransposeIK3D : MonoBehaviour
    {
        ...
        void Solve()
        {
            ...
            while (error > tolerance && iterations < maxIterations)
            {
                ...
                Vector3 j1dv = Vector3.Cross(f, (jointEnd.position - joint1.position));
                Vector3 j2dv = Vector3.Cross(joint1.up, (jointEnd.position - joint2.position));
                Vector3 j3dv = Vector3.Cross(joint2.right, (jointEnd.position - joint3.position));
                Vector3 j4dv = Vector3.Cross(joint3.forward, (jointEnd.position - joint4.position));
                ...
                O.x = joint1.localEulerAngles.z;
                O.y = joint2.localEulerAngles.y;
                O.z = joint3.localEulerAngles.x;
                O.w = joint4.localEulerAngles.z;
                ...
                joint1.localEulerAngles = new Vector3(0, 0, O.x);
                joint2.localEulerAngles = new Vector3(0, O.y, 0);
                joint3.localEulerAngles = new Vector3(O.z, 0, 0);
                joint4.localEulerAngles = new Vector3(0, 0, O.w);
